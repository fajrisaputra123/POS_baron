...
<div class="container py-5 text-center" style="max-width: 650px;">
    <!-- Header Utama -->
    <h3 class="fw-bold text-dark mb-2">POS Baron Food & Culinary</h3>
    <p class="text-secondary mb-4">
        Sistem penyedia kuliner lokal pilihan yang menyajikan hidangan berkualitas dengan bahan segar dan resep autentik Nusantara[cite: 1.2].
    </p>
    ...
    <div class="p-4 border rounded-4 bg-light shadow-sm mb-4">
        <div class="row g-3">
            <div class="col-4">
                ...
                <small class="text-muted fs-7">Bahan lokal pilihan</small>
            </div>
            <div class="col-4 border-start border-end">
                <h6 class="fw-bold text-danger mb-1">Alami</h6>
                <small class="text-muted fs-7">Tanpa pengawet</small>
            </div>
            <div class="col-4">
    ...
    <div class="p-4 border rounded-4 bg-white text-start shadow-sm">
        ...
        <div class="row g-2 text-secondary">
            ...
            <div class="col-7 text-dark fw-bold">POS Baron Food & Culinary</div>
